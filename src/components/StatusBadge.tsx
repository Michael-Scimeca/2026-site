...
export function StatusBadge() {
    ...
    return (
        <div className="flex items-center gap-3 bg-white py-2 px-4 shadow-xl rounded-[20px]">
            <div className="relative flex items-center justify-center w-3 h-3">
                <span
            ...
            <div className="flex flex-row items-center gap-2 md:gap-3 leading-none">
                ...
                {weather && (
                    <>
                        ...
                        <span className="hidden md:block text-[10px] tracking-[0.05em] font-bold text-zinc-900 tabular-nums uppercase whitespace-nowrap">
                            {weather.temp}°F
                        </span>
