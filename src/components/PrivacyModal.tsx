...
export function PrivacyModal() {
    ...
    return (
        ...
        >
            <div
                ref={modalRef}
                className="bg-zinc-950 text-white border border-zinc-800 rounded-lg shadow-2xl max-w-lg w-full p-6 md:p-8 relative overflow-hidden"
            >
                {/* Close Button */}
                <button
                ...
                <div className="space-y-4">
                    ...
                    <div className="text-sm text-zinc-400 leading-relaxed space-y-4">
                        ...
                        <p>
                            You may opt out of receiving this advertising by visiting <a href="https://app.retention.com/optout" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">https://app.retention.com/optout</a>.
                        </p>
                        <p>
                            You also have the option to opt out of the collection of your personal data in compliance with GDPR. To exercise this option, please visit <a href="https://www.rb2b.com/rb2b-gdpr-opt-out" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">https://www.rb2b.com/rb2b-gdpr-opt-out</a>.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-4">
                        ...
                        <button
                            ...
                            className="flex-1 px-6 py-2.5 bg-transparent border border-zinc-700 hover:bg-zinc-900 text-white font-medium rounded-md transition-colors text-sm"
                        >
                            Reject All
                        </button>
                    </div>
